...
function azc_tsh_load_css(){
	wp_register_style( 'azc_tsh', plugins_url( 'style.css', __FILE__ ), '', '1.0.0' );
	wp_enqueue_style( 'azc_tsh', plugins_url( 'style.css', __FILE__ ), '', '1.0.0' );
	...
	if (strlen($custom_css) > 0){
		wp_add_inline_style( 'azc_tsh', $custom_css );
	}
}

function azc_tsh_load_jquery(){
	wp_enqueue_script( 'azc_tsh', plugins_url('jquery.js', __FILE__), array('jquery'), '3.9.1');
}
...
function azc_tsh_load_plugin_textdomain(){
	...
	$loaded = load_plugin_textdomain( 'azc_tsh', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
...
function azc_tsh_config_page() {
	if (!current_user_can('manage_options')) {
        wp_die(__('You do not have sufficient permissions to access this page.', 'azc_tsh'));
    }
	...
	<div id="azc-tsh-general" class="wrap">
		<fieldset>
			<h2>azurecurve Toggle Show/Hide <?php _e('Settings', 'azc_tsh'); ?></h2>
			...
			<form method="post" action="admin-post.php">
				...
				<tr><td colspan=2>
					<p><?php _e('If the options are blank then the defaults in the plugin\'s CSS will be used.', 'azc_tsh'); ?></p>
				</td></tr>
				<?php if (function_exists('is_multisite') && is_multisite()) { ?>
					<tr><th scope="row">Use multisite options instead of the site options below?</th><td>
						<fieldset><legend class="screen-reader-text"><span><?php _e('Disable images in toggle title?', 'azc_tsh'); ?></span></legend>
				...
				<?php } ?>
				<tr><th scope="row"><label for="title"><?php _e('Title', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="title" value="<?php echo esc_html( stripslashes($options['title']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default title text (e.g. Click here to toggle show/hide)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="width"><?php _e('Width', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="width" value="<?php echo esc_html( stripslashes($options['width']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default width (e.g. 65% or 500px)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="border"><?php _e('Border', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="border" value="<?php echo esc_html( stripslashes($options['border']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default border (e.g. 1px solid #00F000)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="title_color"><?php _e('Title Color', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="title_color" value="<?php echo esc_html( stripslashes($options['title_color']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default title color (e.g. #000)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="bg_title"><?php _e('Title Background Color', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="bg_title" value="<?php echo esc_html( stripslashes($options['bg_title']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default title background color (e.g. 1px solid #00F000)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="title_font"><?php _e('Title Font Family', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="title_font" value="<?php echo esc_html( stripslashes($options['title_font']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default title font family (e.g. Arial, Calibri)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="title_font_size"><?php _e('Title Font Size', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="title_font_size" value="<?php echo esc_html( stripslashes($options['title_font_size']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default title font size (e.g. 1.2em or 14px)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="title_font_weight"><?php _e('Title Font Weight', 'azc_tsh'); ?></label></th><td>
					...
					<p class="description"><?php _e('Set default title font weight (e.g. 600)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="text_color"><?php _e('Text Color', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="text_color" value="<?php echo esc_html( stripslashes($options['text_color']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default text color (e.g. #000)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="bg_text"><?php _e('Text Background Color', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="bg_text" value="<?php echo esc_html( stripslashes($options['bg_text']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default bg_text (e.g. 1px solid #00F000)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="text_font"><?php _e('Text Font Family', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="text_font" value="<?php echo esc_html( stripslashes($options['text_font']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default text font family (e.g. Arial, Calibri)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="text_font_size"><?php _e('Text Font Size', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="text_font_size" value="<?php echo esc_html( stripslashes($options['text_font_size']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default text font size (e.g. 1.2em or 14px)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="text_font_weight"><?php _e('Text Font Weight', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="text_font_weight" value="<?php echo esc_html( stripslashes($options['text_font_weight']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default text font weight (e.g. 600)', 'azc_tsh'); ?></p>
				</td></tr>
				...
				<tr><th scope="row">Disable images?</th><td>
					<fieldset><legend class="screen-reader-text"><span><?php _e('Disable images in toggle title?', 'azc_tsh'); ?></span></legend>
					<label for="disable_image"><input name="disable_image" type="checkbox" id="disable_image" value="1" <?php checked( '1', $options['disable_image'] ); ?> /><?php _e('Disable images in toggle title? Override setting by putting disable_image=0 in toggle.', 'azc_tsh'); ?></label>
					</fieldset>
				</td></tr>
				<tr><th scope="row">Allow Shortcodes?</th><td>
					<fieldset><legend class="screen-reader-text"><span><?php _e('Allow shortcodes within toggle?', 'azc_tsh'); ?></span></legend>
					<label for="allow_shortcodes"><input name="allow_shortcodes" type="checkbox" id="allow_shortcodes" value="1" <?php checked( '1', $options['allow_shortcodes'] ); ?> /><?php _e('Allow shortcodes within toggle?', 'azc_tsh'); ?></label>
					</fieldset>
				</td></tr>
				</table>
...
function process_azc_tsh_options() {
	...
	if ( !current_user_can( 'manage_options' ) ){
		wp_die( __('You do not have permissions for this action', 'azc_tsh'));
	}
...
function azc_tsh_network_settings_page(){
	...
	<div id="azc-tsh-general" class="wrap">
		<fieldset>
			<h2>azurecurve Toggle Show/Hide <?php _e('Network Settings', 'azc_tsh'); ?></h2>
			<?php if( isset($_GET['settings-updated']) ) { ?>
				<div id="message" class="updated">
			...
			<form method="post" action="admin-post.php">
				...
				<table class="form-table">
				<tr><td colspan=2>
					<p><?php _e('If multisite is being used these options will be used when Use Multisite enabled in Site Options; if the options are blank the defaults in the plugin\'s CSS will be used.', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="title"><?php _e('Title', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="title" value="<?php echo esc_html( stripslashes($options['title']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default title text (e.g. Click here to toggle show/hide)', 'azc_tsh'); ?></p>
				...
				<tr><th scope="row"><label for="width"><?php _e('Width', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="width" value="<?php echo esc_html( stripslashes($options['width']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default width (e.g. 65% or 450px)', 'azc_tsh'); ?></p>
				</td></tr>
				<tr><th scope="row"><label for="border"><?php _e('Border', 'azc_tsh'); ?></label></th><td>
					<input type="text" name="border" value="<?php echo esc_html( stripslashes($options['border']) ); ?>" class="large-text" />
					<p class="description"><?php _e('Set default border (e.g. 1px solid #00F000)', 'azc_tsh'); ?></p>
