...
<div class="post-author clearfix">
	...
	<p class="post-author_gravatar"><span class="extraimg_1 "><em></em><?php if(function_exists('get_avatar')) { echo get_avatar( get_the_author_meta('email'), '70' ); /* This avatar is the user's gravatar (http://gravatar.com) based on their administrative email address */  } ?></span></p>
