...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '13px', 'lineheight' => '20px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#797c80'));
			...
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '42px', 'lineheight' => '42px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#393c3d'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '17px', 'lineheight' => '24px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#494d52'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '52px', 'lineheight' => '54px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#393c3d'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '15px', 'lineheight' => '22px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#393c3d'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '13px', 'lineheight' => '20px', 'face' => 'Ubuntu', 'style' => 'normal', 'character'  => 'latin', 'color' => '#494d52'));
